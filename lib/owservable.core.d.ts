...
export { OwservableClient, EStoreType, BackendRegistry, initiateCronjobs, initiateWatchers, initiateWorkers, addActionCronjobs, addActionWatchers, addActionWorkers, executeCronjob, executeWatcher, executeWorker, executeProcessesInFolder, executeOnFilesRecursively, DataMiddlewareMap, AStore, CountStore, DocumentStore, CollectionStore, storeFactory };
export type { BackendChangeType, ConnectionManagerRefreshType, CronJobType, LifecycleEvent, StoreScopeType, StoreSubscriptionConfigType, StoreSubscriptionUpdateType, SubscriptionMethodsType, WatcherType, WorkerType, IConnectionManager, IObservableBackend };
declare const OwservableCore: {};
